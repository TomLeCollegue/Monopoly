...
public class Plateau {
    ...
    private ArrayList<Case> createCase(){
        ...
        bleu.proprietes.add((Propriete) rueDeLaPaix);
        Case AvenueEly = new Terrain(350,35,"Avenue des champs Elysées",rueDeLaPaix, bleu);
        cases.add(AvenueEly);
        bleu.proprietes.add((Propriete) AvenueEly);
        ...
        jaune.proprietes.add((Propriete) PlaceBourse);
        Case StHonore = new Terrain(260,22,"Faubourg st honoré",PlaceBourse, jaune);
        cases.add(StHonore);
        jaune.proprietes.add((Propriete) StHonore);
        ...
        cases.add(paradis);
        rose.proprietes.add((Propriete) paradis);
        Case neuilly = new Terrain(140,10,"Avenue de Neuilly",paradis, rose);
        cases.add(neuilly);
        rose.proprietes.add((Propriete) neuilly);
